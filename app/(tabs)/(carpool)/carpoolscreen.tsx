  ...
  return (
    <View style={{ flex: 1, paddingTop: 100, justifyContent: "flex-start" }}>
      ...
      {cards.map(card => (
        ...
        {cards.length<=0 &&
          <Text style={{ color: "gray", fontSize:12, width:300, textAlign:"center"}}>You have no carpools setup yet. Click the plus or search icon to add one. Use the refresh button to sync data </Text>
        }
      </ScrollView>
    </View>
  );
